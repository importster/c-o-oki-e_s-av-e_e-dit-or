var LZString = {
    ...
    _getBaseValue: function(r, e) {
        ...
        !LZString._baseReverseDic[r]) {
            ...
            for (var n = 0; n < r.length; n++)
                LZString._baseReverseDic[r][r[n]] = n
        }
    ...
    _compress: function(r, e, n) {
        ...
        for (i = 0; i < r.length; i += 1)
            if (p = r[i],
            Object.prototype.hasOwnProperty.call(s, p) || (s[p] = f++,
            a[p] = !0),
            u = c + p,
    ...
    _decompress: function(r, e, n) {
        var o, t, i, s, a, p, u, c, l = [], f = 4, h = 4, g = 3, d = "", S = [], m = LZString._f, v = {
            val: n(0),
            position: e,
            index: 1
        };
